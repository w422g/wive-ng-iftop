...
MKDIRS="sh /opt/Wive/APP/iftop/ncurses/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /opt/Wive/APP/iftop/ncurses/man_alias.sed ; then
cat >>/opt/Wive/APP/iftop/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /opt/Wive/APP/iftop/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /opt/Wive/APP/iftop/ncurses/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /opt/Wive/APP/iftop/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /opt/Wive/APP/iftop/ncurses/man_alias.sed \
		< $i | sed -f /opt/Wive/APP/iftop/ncurses/edit_man.sed >$TMP
